  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-0.5 max-w-full">
            <button
              ...
              className={`flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold transition-all whitespace-nowrap flex-shrink-0 ${
                filterType === 'all'
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="text-xs text-slate-500 pt-0.5 flex flex-wrap items-center gap-1">
                      <span>Last screening: </span>
                      <strong className="text-slate-800 font-bold">{patient.lastScreeningDate}</strong>
                      <span className="sm:ml-2 font-bold text-sky-700">
        ...
        <div className="bg-[#f3f1fe] rounded-2xl p-4 sm:p-5 border border-[#e2e0f5] flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full md:w-auto">
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-4 py-2.5 sm:py-2 bg-[#e8e6fd] hover:bg-[#dedaff] text-[#076694] text-xs font-bold rounded-xl transition-all shadow-xs min-h-[44px] sm:min-h-0"
            >
